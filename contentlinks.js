...
var ENGINES = {
	Google: 'https://www.google.com/search?num=30&q=',
	Ali: 'https://www.aliexpress.com/wholesale?SortType=total_tranpro_desc&isRtl=yes&SearchText=',
	Amazon: 'https://www.amazon.com/gp/search?tag=ilovevitaly-20&keywords=',
	Bing: 'https://www.bing.com/search?q=',
	Baidu: 'https://www.baidu.com/s?wd=',
	Duck: 'https://duckduckgo.com/?q=',
	Stack: 'https://stackoverflow.com/search?q=',
	Shopping: 'http://searchmonster.net/?s=',
	Travel: 'http://searchmonster.net/?s=',
	"Search Monster": 'http://searchmonster.net/?s=',
...
function getNodes(){
	...
	if(!trg){
		window.setTimeout(getNodes,500);
		return;
	}
...
window.setTimeout(onDOMLoad,500); //onDOMLoad();
window.setTimeout(getNodes,500); //getNodes();
